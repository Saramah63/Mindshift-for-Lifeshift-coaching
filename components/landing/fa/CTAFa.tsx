  ...
  return (
    <section id="contact" className="py-24 px-4 bg-gradient-to-br from-blue-600 via-indigo-700 to-purple-700 text-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <h2 className="mb-6 text-white">آماده تحول زندگی خود هستید؟</h2>
        <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto leading-relaxed">
          اولین قدم را به سمت وضوح، رشد و موفقیت بردارید.
          امروز مشاوره رایگان خود را برنامه‌ریزی کنید و کشف کنید که چگونه کوچینگ می‌تواند به شما کمک کند به اهداف خود برسید.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
            ...
            <p className="text-blue-100">مشتریان در سراسر جهان</p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
            <p className="text-3xl mb-2">💬</p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
            <p className="text-3xl mb-2">✨</p>
            <p className="text-blue-100">نتایج تحول‌آفرین</p>
          </div>
        </div>
      </div>
    </section>
